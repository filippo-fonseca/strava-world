  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="border-b border-[var(--line)]">
        <div className="mx-auto w-full max-w-[1400px] px-[max(0.75rem,var(--safe-left))] py-2.5 pr-[max(0.75rem,var(--safe-right))] sm:px-5">
          <div className="flex items-center gap-3">
            <Link
              href="/map"
              className="shrink-0 font-[family-name:var(--font-display)] text-base font-semibold tracking-tight text-[var(--ink-display)] lowercase"
            >
              strava world
            </Link>
